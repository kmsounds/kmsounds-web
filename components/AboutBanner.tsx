...
import { FaInfoCircle, FaArrowRight, FaVolumeUp } from "react-icons/fa";

export function AboutBanner() {
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 my-8 sm:hidden">
      <div className="relative group overflow-hidden rounded-2xl bg-gradient-to-r from-cyan-950/80 via-neutral-900 to-black border border-cyan-500/40 hover:border-cyan-400 shadow-[0_0_30px_rgba(6,182,212,0.15)] hover:shadow-[0_0_40px_rgba(6,182,212,0.3)] transition-all duration-500">
          ...
          <div className="flex items-center gap-3 text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
              <span className="text-white font-extrabold text-sm sm:text-lg tracking-wide flex items-center justify-center sm:justify-start gap-2">
                <FaInfoCircle className="text-cyan-400 text-base" /> About K.M SOUNDS
              </span>
              <span className="text-gray-400 text-xs sm:text-sm hidden md:inline">
                • Professional Audio Equipment & Cabinet Manufacturing
              </span>
            </div>
          </div>
